...
int main() {
  std::vector<char> result1 = uniqueInOrder("AAAABBBCCDAABBB"); // result should be {'A', 'B', 'C', 'D', 'A', 'B'}
  std::vector<char> result2 = uniqueInOrder("ABBCcAD"); // result should be {'A', 'B', 'C', 'c', 'A', 'D'}
  std::vector<int> result3 = uniqueInOrder(std::vector<int>{1,2,2,3,3});  // result should be {1,2,3}
